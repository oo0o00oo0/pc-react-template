...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (app.xr.isAvailable("immersive-ar")) {
    ...
    dom.arMode.addEventListener("click", () =>
      app.xr.start(
  ...
  if (app.xr.isAvailable("immersive-vr")) {
    ...
    dom.vrMode.addEventListener("click", () =>
      app.xr.start(
        app.root.findComponent("camera"),
        "immersive-vr",
        "local-floor"
  ...
  if (document.documentElement.requestFullscreen && document.exitFullscreen) {
    ...
    dom.exitFullscreen.addEventListener("click", () =>
      document.exitFullscreen()
    );
    document.addEventListener("fullscreenchange", () => {
      dom.enterFullscreen.classList[
        document.fullscreenElement ? "add" : "remove"
      ]("hidden");
      dom.exitFullscreen.classList[
        document.fullscreenElement ? "remove" : "add"
      ]("hidden");
    });
  }
